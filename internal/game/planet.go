...
type Planet struct {
	...
	// The `LastActivity` defines the last date at which an
	// event occurred on this planet. It can correspond to
	// an activity generated by the player or by another
	// player.
...
func NewPlanet(player string, coords Coordinate, homeworld bool, data Instance) (*Planet, error) {
	...
	p := &Planet{
		...
		// The last activity is when the planet is
		// created by default.
