...
DROP FUNCTION planet_fight_aftermath(target_id uuid, kind text, planet_ships json, planet_defenses json, pillage json, debris json, moon boolean, diameter integer, moment timestamp with time zone);
