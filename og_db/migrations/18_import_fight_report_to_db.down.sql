...
DROP FUNCTION fight_report(players json, fleets json, indigenous uuid, planet_id uuid, planet_kind text, outcome text, fleet_remains json, ships_remains json, def_remains json, pillage json, debris json, rebuilt json);

-- Drop the function handling the generation of a fight report footer.
DROP FUNCTION fleet_fight_report_footer(player_id uuid, pillage json, debris json, rebuilt json);
...
DROP FUNCTION fleet_fight_report_header(player_id uuid, planet_id uuid, planet_kind text);
