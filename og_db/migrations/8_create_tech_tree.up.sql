...
CREATE TABLE tech_tree_buildings_dependencies (
  building uuid NOT NULL references buildings,
  requirement uuid NOT NULL references buildings,
  level integer NOT NULL
);

-- Create the table defining dependencies between technologies.
CREATE TABLE tech_tree_technologies_dependencies (
  technology uuid NOT NULL references technologies,
  requirement uuid NOT NULL references technologies,
  level integer NOT NULL
);
...
INSERT INTO public.tech_tree_technologies_vs_buildings ("technology", "requirement", "level")
  VALUES(
    (SELECT id FROM technologies WHERE name='espionage'),
...
INSERT INTO public.tech_tree_ships_vs_buildings ("ship", "requirement", "level")
  VALUES(
...
INSERT INTO public.tech_tree_ships_vs_technologies ("ship", "requirement", "level")
  VALUES(
    (SELECT id FROM ships WHERE name='small cargo ship'),
    (SELECT id FROM technologies WHERE name='combustion drive'),
    2
...
INSERT INTO public.tech_tree_defenses_vs_buildings ("defense", "requirement", "level")
  VALUES(
...
INSERT INTO public.tech_tree_defenses_vs_technologies ("defense", "requirement", "level")
  VALUES(
    (SELECT id FROM defenses WHERE name='light laser'),
    (SELECT id FROM technologies WHERE name='energy'),
    1
